...
<div class="panel-car-footer">
    <button class="btn btn-lg btn-primary btn-block"  type="button" onclick="finalizarPedido(${pedido.codigo}, ${bloqueiaFinalizar}, ${pedido.mesa.numero});">Finalizar Pedido</button> 
</div>