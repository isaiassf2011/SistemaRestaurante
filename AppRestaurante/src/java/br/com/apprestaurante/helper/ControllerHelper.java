...
import br.com.apprestaurante.command.AlterarSenha;
import br.com.apprestaurante.command.AutenticaRestaurante;
import br.com.apprestaurante.command.BuscarMesa;
import br.com.apprestaurante.command.BuscarMesaNumero;
import br.com.apprestaurante.command.BuscarMesaPorNumero;
...
import br.com.apprestaurante.command.BuscarRestaurantePorCnpj;
...
import br.com.apprestaurante.command.RelatorioPedidoPeriodo;
...
public class ControllerHelper {
    ...
    public ControllerHelper() {
        ...
        comandos.put(AcaoConstante.ALTERAR_SENHA, new AlterarSenha());
        comandos.put(AcaoConstante.RELATORIO_PEDIDO_PERIODO, new RelatorioPedidoPeriodo());
        ...
        comandos.put(AcaoConstante.BUSCAR_MESA_POR_NUMERO, new BuscarMesaPorNumero());
        ...
        comandos.put(AcaoConstante.BUSCAR_RESTAURANTE_POR_CNPJ, new BuscarRestaurantePorCnpj());
        comandos.put(AcaoConstante.BUSCAR_PRODUTO, new BuscarProduto());
        comandos.put(AcaoConstante.BUSCAR_MESA, new BuscarMesa());
        comandos.put(AcaoConstante.BUSCAR_MESA_NUMERO, new BuscarMesaNumero());
